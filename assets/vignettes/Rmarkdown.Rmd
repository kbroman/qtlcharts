...
[R/qtlcharts](https://kbroman.org/qtlcharts) is an R package to
...
[R Markdown](https://rmarkdown.rstudio.com)-based reports.

[R Markdown](https://rmarkdown.rstudio.com) is a
extension of [Markdown](https://daringfireball.net/projects/markdown/),
using [knitr](https://yihui.name/knitr/), to write simply-marked-up
...
To include [R/qtlcharts](https://kbroman.org/qtlcharts)-based
...
[Moore et al. Genetics 195:1077-1086, 2013](https://www.ncbi.nlm.nih.gov/pubmed/23979570),
