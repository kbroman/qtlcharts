...
[`main` branch](https://github.com/kbroman/qtlcharts/tree/main)
contains the stable version.

R/qtlcharts uses [htmlwidgets](https://www.htmlwidgets.org) as the
...
[`inst/htmlwidgets`](https://github.com/kbroman/qtlcharts/tree/main/inst/htmlwidgets)
...
[`inst/htmlwidgets/lib`](https://github.com/kbroman/qtlcharts/tree/main/inst/htmlwidgets/lib).
...
[`inst/htmlwidgets/lib/qtlcharts`](https://github.com/kbroman/qtlcharts/tree/main/inst/htmlwidgets/lib/qtlcharts). Each
...
[`inst/htmlwidgets/lib/qtlcharts`](https://github.com/kbroman/qtlcharts/tree/main/inst/htmlwidgets/lib/qtlcharts).
...
[`iplotCorr.coffee`](https://github.com/kbroman/qtlcharts/tree/main/inst/htmlwidgets/lib/qtlcharts/iplotCorr.coffee)).
...
([`grab_chartOpts.rb`](https://github.com/kbroman/qtlcharts/blob/main/vignettes/chartOpts/grab_chartOpts.rb))
...
genotype).  The file [`multiversions.csv`](https://github.com/kbroman/qtlcharts/blob/main/vignettes/chartOpts/multiversions.csv)
...
in [Hadley Wickham](https://hadley.nz)'s [R packages](https://r-pkgs.org) book,
...
[`tests/testthat`](https://github.com/kbroman/qtlcharts/tree/main/tests/testthat). We're
using the R package [testthat](https://github.com/r-lib/testthat).

We also generate a couple of tests for each of the higher-level chart
functions: in the usual simple way (see
[`tests/htmltest`](https://github.com/kbroman/qtlcharts/tree/main/tests/htmltest)),
and within the context of an
[R Markdown](https://rmarkdown.rstudio.com) document (see
[`tests/Rmdtest`](https://github.com/kbroman/qtlcharts/tree/main/tests/Rmdtest)).
...
- [d3panels](https://github.com/kbroman/d3panels) ([license](https://github.com/kbroman/qtlcharts/blob/main/inst/htmlwidgets/lib/d3panels/LICENSE.md))
