...
iplotScanone_pxg = function(lod_data, pxg_data, chartOpts) {
  var chartdivid, chrGap, darkrect, eff_axispos, eff_nyticks, eff_pointcolor, eff_pointcolorhilit, eff_pointsize, eff_pointstroke, eff_rotate_ylab, eff_titlepos, eff_xjitter, eff_xlab, eff_yNA, eff_ylab, eff_ylim, eff_yticks, g_lod, height, lightrect, lod_axispos, lod_linecolor, lod_linewidth, lod_nyticks, lod_pointcolor, lod_pointsize, lod_pointstroke, lod_rotate_ylab, lod_title, lod_titlepos, lod_xlab, lod_ylab, lod_ylim, lod_yticks, margin, markers, mylodchart, plotPXG, svg, totalh, totalw, wleft, wright, x, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref28, _ref29, _ref3, _ref30, _ref31, _ref32, _ref33, _ref34, _ref35, _ref36, _ref37, _ref38, _ref39, _ref4, _ref40, _ref41, _ref5, _ref6, _ref7, _ref8, _ref9;
  markers = (function() {
    var _results;
    _results = [];
  ...
  eff_pointsize = typeof chartOpts === "function" ? chartOpts(eff_pointsize != null ? eff_pointsize : typeof chartOpts === "function" ? chartOpts(typeof pointsize !== "undefined" && pointsize !== null ? pointsize : 3) : void 0) : void 0;
  eff_ylim = (_ref29 = chartOpts != null ? chartOpts.eff_ylim : void 0) != null ? _ref29 : null;
  eff_nyticks = (_ref30 = chartOpts != null ? chartOpts.eff_nyticks : void 0) != null ? _ref30 : null;
  eff_yticks = (_ref31 = chartOpts != null ? chartOpts.eff_yticks : void 0) != null ? _ref31 : null;
  eff_xlab = (_ref32 = chartOpts != null ? chartOpts.eff_xlab : void 0) != null ? _ref32 : "Genotype";
  eff_ylab = (_ref33 = chartOpts != null ? chartOpts.eff_ylab : void 0) != null ? _ref33 : "Phenotype";
  eff_rotate_ylab = (_ref34 = chartOpts != null ? chartOpts.eff_rotate_ylab : void 0) != null ? _ref34 : null;
  eff_xjitter = (_ref35 = chartOpts != null ? chartOpts.xjitter : void 0) != null ? _ref35 : null;
  eff_axispos = (_ref36 = (_ref37 = chartOpts != null ? chartOpts.eff_axispos : void 0) != null ? _ref37 : chartOpts != null ? chartOpts.axispos : void 0) != null ? _ref36 : {
    xtitle: 25,
    ytitle: 30,
    xlabel: 5,
    ylabel: 5
  };
  eff_titlepos = (_ref38 = (_ref39 = chartOpts != null ? chartOpts.eff_titlepos : void 0) != null ? _ref39 : chartOpts != null ? chartOpts.titlepos : void 0) != null ? _ref38 : 20;
  eff_yNA = (_ref40 = chartOpts != null ? chartOpts.eff_yNA : void 0) != null ? _ref40 : {
    handle: true,
    force: false,
    width: 15,
    gap: 10
  };
  chartdivid = (_ref41 = chartOpts != null ? chartOpts.chartdivid : void 0) != null ? _ref41 : 'chart';
  ...
  plotPXG = function(markername, markerindex) {
    var chr, chrtype, g, gabs, genonames, inferred, mypxgchart, _i, _ref42, _results;
    ...
    mypxgchart = dotchart().height(height).width(wright).margin(margin).xcategories((function() {
      _results = [];
      for (var _i = 1, _ref42 = genonames.length; 1 <= _ref42 ? _i <= _ref42 : _i >= _ref42; 1 <= _ref42 ? _i++ : _i--){ _results.push(_i); }
      return _results;
    }).apply(this)).xcatlabels(genonames).dataByInd(false).title(markername).xvar('geno').yvar('pheno').axispos(eff_axispos).titlepos(eff_titlepos).xlab(eff_xlab).ylab(eff_ylab).rotate_ylab(eff_rotate_ylab).ylim(eff_ylim).nyticks(eff_nyticks).yticks(eff_yticks).pointcolor(eff_pointcolor).pointstroke(eff_pointstroke).pointsize(eff_pointsize).rectcolor(lightrect).xjitter(eff_xjitter).yNA(eff_yNA);
