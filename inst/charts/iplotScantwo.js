...
var add_symmetric_lod, iplotScantwo, lod_for_heatmap, mydotchart;
...
iplotScantwo = function(scantwo_data, pheno_and_geno, chartOpts) {
  ...
  return plot_effects = function(markerindex1, markerindex2) {
    ...
    return g_eff[1].select("svg").append("g").attr("class", "x axis").selectAll("empty").data([mar1, mar2]).enter().append("text").attr("x", margin.left).attr("y", function(d, i) {
