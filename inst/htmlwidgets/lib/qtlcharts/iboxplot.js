...
iboxplot = function(widgetdiv, data, chartOpts) {
  ...
  ylab = (ref3 = chartOpts != null ? chartOpts.ylab : void 0) != null ? ref3 : "Response";
  xlab = (ref4 = chartOpts != null ? chartOpts.xlab : void 0) != null ? ref4 : "Individuals";
  rectcolor = (ref5 = chartOpts != null ? chartOpts.rectcolor : void 0) != null ? ref5 : "#E6E6E6";
  qucolors = (ref6 = chartOpts != null ? chartOpts.qucolors : void 0) != null ? ref6 : null;
  ...
  yScale = d3.scale.linear().domain(topylim).range([halfheight - margin.bottom, margin.top]);
  quline = function(j) {
  ...
  if (qucolors == null) {
    ...
    qucolors = ["black"];
    for (l = 0, len1 = colindex.length; l < len1; l++) {
      j = colindex[l];
      qucolors.push(tmp(j));
    }
  }
  ...
  ref10 = qucolors.slice(0, -1).reverse();
  for (n = 0, len2 = ref10.length; n < len2; n++) {
    color = ref10[n];
    qucolors.push(color);
  }
  curves = svg.append("g").attr("id", "curves");
  for (j = o = 0, ref11 = nQuant; 0 <= ref11 ? o < ref11 : o > ref11; j = 0 <= ref11 ? ++o : --o) {
  ...
  lowyScale = d3.scale.linear().domain([0, botylim[1] + 1]).range([halfheight - margin.bottom, margin.top]);
