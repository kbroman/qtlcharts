...
iboxplot = function(el, data, chartOpts) {
  ...
  svg = d3.select(el).select("svg").append("svg").attr("width", width).attr("height", halfheight).attr("class", "qtlcharts");
  ...
  lowsvg = d3.select(el).select("svg").append("g").attr("id", "lower_svg").attr("transform", "translate(0," + halfheight + ")").append("svg").attr("height", halfheight).attr("width", width).attr("class", "qtlcharts");
