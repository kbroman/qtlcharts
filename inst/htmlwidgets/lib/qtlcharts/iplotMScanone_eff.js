...
iplotMScanone_eff = function(el, lod_data, eff_data, times, chartOpts) {
  var axispos, chartdivid, chr, chrGap, colors, curindex, curvechart_xaxis, darkrect, eff_linecolor, eff_linewidth, eff_nlines, eff_ylab, eff_ylim, effchart_curves, effcurve, extra_digits, g_curvechart, g_heatmap, g_lodchart, hbot, height, htop, lightrect, linecolor, linewidth, lod_labels, lod_ylab, lodchart_curves, lodcurve, margin, mycurvechart, mylodchart, mylodheatmap, nullcolor, nxticks, plotEffCurves, plotLodCurve, pos, posindex, svg, titlepos, width, wleft, wright, x, xscale, xticks, zlim, zthresh, _i, _j, _len, _len1, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
  height = (_ref = chartOpts != null ? chartOpts.height : void 0) != null ? _ref : 700;
  width = (_ref1 = chartOpts != null ? chartOpts.width : void 0) != null ? _ref1 : 1000;
  wleft = (_ref2 = chartOpts != null ? chartOpts.wleft : void 0) != null ? _ref2 : width * 0.65;
  htop = (_ref3 = chartOpts != null ? chartOpts.htop : void 0) != null ? _ref3 : height / 2;
  ...
  eff_ylim = (_ref15 = chartOpts != null ? chartOpts.eff_ylim : void 0) != null ? _ref15 : null;
  eff_ylab = (_ref16 = chartOpts != null ? chartOpts.eff_ylab : void 0) != null ? _ref16 : "";
  linecolor = (_ref17 = chartOpts != null ? chartOpts.linecolor : void 0) != null ? _ref17 : "darkslateblue";
  eff_linecolor = (_ref18 = chartOpts != null ? chartOpts.eff_linecolor : void 0) != null ? _ref18 : null;
  linewidth = (_ref19 = chartOpts != null ? chartOpts.linewidth : void 0) != null ? _ref19 : 2;
  eff_linewidth = (_ref20 = chartOpts != null ? chartOpts.eff_linewidth : void 0) != null ? _ref20 : 2;
  nxticks = (_ref21 = chartOpts != null ? chartOpts.nxticks : void 0) != null ? _ref21 : 5;
  xticks = (_ref22 = chartOpts != null ? chartOpts.xticks : void 0) != null ? _ref22 : null;
  lod_labels = (_ref23 = chartOpts != null ? chartOpts.lod_labels : void 0) != null ? _ref23 : null;
  chartdivid = (_ref24 = chartOpts != null ? chartOpts.chartdivid : void 0) != null ? _ref24 : 'chart';
  wright = width - wleft;
  hbot = height - htop;
  if (lod_labels == null) {
  ...
  plotLodCurve = function(lodcolumn) {
    var chr, _i, _len, _ref25, _results;
    lodchart_curves = g_lodchart.append("g").attr("id", "lodcurves");
    _ref25 = lod_data.chrnames;
    _results = [];
