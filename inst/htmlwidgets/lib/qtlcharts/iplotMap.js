...
iplotMap = function iplotMap(widgetdiv, data, chartOpts) {
  var axispos, chartdivid, clean_marker_name, div, height, horizontal, linecolor, linecolorhilit, linewidth, margin, markerSelect, martip, mychart, nyticks, rectcolor, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, selectedMarker, shiftStart, svg, tickwidth, title, titlepos, widgetdivid, width, xlab, xlineOpts, ylab, ylim, yticks; // chartOpts start
  ...
  $("div#markerinput_" + widgetdivid).submit(function (event) {
    ...
    if (newSelection !== "") {
      if (data.marker.indexOf(newSelection) >= 0) {
        ...
        line = div.select("line#" + clean_marker_name(selectedMarker)).attr("stroke", linecolorhilit); // showmartip here
        // activate marker tip here, location of line.node(), using data line.datum()

        d = line.datum();
        pos = d3.format(".1f")(data.pos[data.marker.indexOf(d)]); // get x,y position
