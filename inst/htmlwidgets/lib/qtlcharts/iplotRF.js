...
iplotRF = function(widgetdiv, rf_data, geno, chartOpts) {
  ...
  colors = (ref10 = chartOpts != null ? chartOpts.colors : void 0) != null ? ref10 : [
    "crimson",
    "white",
    "slateblue" // vector of three colors for the color scale (negative - zero - positive)
  ];
  ...
  lodlim = (ref25 = chartOpts != null ? chartOpts.lodlim : void 0) != null ? ref25 : [
    0,
    12 // range of LOD values to display; omit below 1st, truncate above 2nd
  ];
...
// grab lod scores for this marker
  ...
  mylodheatmap.cells().on("click", function(d) {
    ...
    if (d.xindex !== d.yindex) {
      create_scan(d.yindex, 1); // if same marker, just show the one panel
    } else {
