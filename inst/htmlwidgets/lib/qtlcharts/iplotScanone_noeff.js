...
iplotScanone_noeff = function(widgetdiv, data, chartOpts) {
  var axispos, chartdivid, chrGap, darkrect, halfh, height, lightrect, linecolor, linewidth, margin, mylodchart, nyticks, pointcolor, pointsize, pointstroke, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20, ref21, ref22, ref23, ref24, ref25, ref26, ref27, ref28, ref29, ref3, ref30, ref31, ref32, ref4, ref5, ref6, ref7, ref8, ref9, rotate_ylab, title, titlepos, totalh, totalw, widgetdivid, width, xlab, ylab, ylim, yticks;
  ...
  chrGap = (ref11 = chartOpts != null ? chartOpts.chrGap : void 0) != null ? ref11 : 8;
  darkrect = (ref12 = chartOpts != null ? chartOpts.darkrect : void 0) != null ? ref12 : "#C8C8C8";
  lightrect = (ref13 = chartOpts != null ? chartOpts.lightrect : void 0) != null ? ref13 : "#E6E6E6";
  ...
  mylodchart = lodchart().lodvarname("lod").height(height - margin.top - margin.bottom).width(width - margin.left - margin.right).margin(margin).axispos(axispos).titlepos(titlepos).ylim(ylim).nyticks(nyticks).yticks(yticks).chrGap(chrGap).darkrect(darkrect).lightrect(lightrect).linecolor(linecolor).linewidth(linewidth).pointcolor(pointcolor).pointsize(pointsize).pointstroke(pointstroke).title(title).xlab(xlab).ylab(ylab).rotate_ylab(rotate_ylab).tipclass(widgetdivid);
  d3.select(widgetdiv).select("svg").datum(data).call(mylodchart);
