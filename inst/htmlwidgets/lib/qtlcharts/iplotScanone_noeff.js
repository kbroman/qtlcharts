...
iplotScanone_noeff = function iplotScanone_noeff(widgetdiv, data, chartOpts) {
  ...
  mylodchart(d3.select(widgetdiv).select("svg"), data); // animate points at markers on click
